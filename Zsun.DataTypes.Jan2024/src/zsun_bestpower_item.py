...
class ZsunBestPowerItem:
    ...
    def export_x_y_ordinates_for_cp_w_prime_modelling(self) -> Dict[int, float]:
        ...
        answer = {
            ...
            120: self.cp_120,
            150: self.cp_150,
            180: self.cp_180,# new new new limit
            # 210: self.cp_210,
            # 240: self.cp_240,
            # 270: self.cp_270,
            # 300: self.cp_300, # new new limit
            # 330: self.cp_330,
            # 360: self.cp_360,
            # 390: self.cp_390,
            # 420: self.cp_420,
            ...
            # 1020: self.cp_1020,
            # 1080: self.cp_1080,
            # 1140: self.cp_1140,# previous limit
            # 1200: self.cp_1200,
            # 1320: self.cp_1320,
            # 1440: self.cp_1440,
            # 1560: self.cp_1560,
    ...
    def export_x_y_ordinates_for_pull_zone_modelling(self) -> Dict[int, float]:
        ...
        answer = {
            ...
            # 90: self.cp_90,
            # 100: self.cp_100,
            # 110: self.cp_110, # old limit
            120: self.cp_120,
            150: self.cp_150, #new limit
            180: self.cp_180,
            210: self.cp_210,
            240: self.cp_240,
            270: self.cp_270,
            ...
            390: self.cp_390,
            420: self.cp_420,
            # 450: self.cp_450,#new new limit
            # 480: self.cp_480,
            # 510: self.cp_510,
            # 540: self.cp_540,
            # 570: self.cp_570,
            # 600: self.cp_600, #new new limit 
            # 660: self.cp_660,
            # 720: self.cp_720,
            # 780: self.cp_780,
            # 840: self.cp_840,
            # 900: self.cp_900,
            # 960: self.cp_960, #new limit
            # 1020: self.cp_1020,
            # 1080: self.cp_1080,
            # 1140: self.cp_1140,
            # 1200: self.cp_1200,
            # 1320: self.cp_1320, # old limit
            # 1440: self.cp_1440,
            # 1560: self.cp_1560,
            # 1680: self.cp_1680,
            # 1800: self.cp_1800,
    ...
    def export_x_y_ordinates_for_one_hour_zone_modelling(self) -> Dict[int, float]:
        ...
        answer = {
            ...
            # 360: self.cp_360,
            # 390: self.cp_390,
            # 420: self.cp_420, # new cut off here
            450: self.cp_450,
            480: self.cp_480,
            510: self.cp_510,
            540: self.cp_540, 
            570: self.cp_570,# previous cut off here
            600: self.cp_600,
            660: self.cp_660,
            720: self.cp_720,
            780: self.cp_780,
            ...
            2160: self.cp_2160,
            2280: self.cp_2280,
            2400: self.cp_2400, # previously here
            # 2520: self.cp_2520,
            # 2640: self.cp_2640,
            # 2760: self.cp_2760,
            # 2880: self.cp_2880,
    ...
    @staticmethod
    def to_dataTransferObject(item: "ZsunBestPowerItem") -> ZsunBestPowerDTO:
        return ZsunBestPowerDTO(
    ...
    @staticmethod
    def from_dataTransferObject(dto: Optional[ZsunBestPowerDTO]) -> "ZsunBestPowerItem":
        if dto is None:
            return ZsunBestPowerItem()
        return ZsunBestPowerItem(
    ...
    @staticmethod
    def from_ZwiftRacingAppProfileDTO(dto: Optional[ZwiftRacingAppProfileDTO]) -> "ZsunBestPowerItem":
        if dto is None:
            return ZsunBestPowerItem()
        return ZsunBestPowerItem(
    ...
    @staticmethod
    def from_ZwiftPowerBestPowerDTO(dto: Optional[ZwiftPowerBestPowerDTO]) -> "ZsunBestPowerItem":
        if dto is None:
            return ZsunBestPowerItem()
