...
from cp_model_cp_watts import do_modelling_with_cp_w_prime_model, do_modelling_with_decay_model
...
def main():
    ...
    for rider_id, rider_cp_data in riders_cp_data.items():
        ...
        cp_model_cp_watts, anaerobic_work_capacity, r_squared, rms, answer = do_modelling_with_cp_w_prime_model(raw_xy_data)
        ...
        rider_cp_data.cp_model_cp_watts = cp_model_cp_watts
        rider_cp_data.cp_model_w_prime= anaerobic_work_capacity
        # model_applied = "cp"

        rider_cp_data.ftp_model_coefficient = constant
        rider_cp_data.ftp_model_exponent = exponent
