...
from handy_utilities import write_dict_of_cpdata, read_many_zwiftpower_graph_files_in_folder, read_dict_of_zwiftriders,get_betel_zwift_ids
...
def main():
    ...
    Dependencies:
        - `read_many_zwiftpower_graph_files_in_folder`: Reads ZwiftPower critical power data files.
