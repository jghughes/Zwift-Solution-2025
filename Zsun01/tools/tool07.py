...
def main():
    ...
    Dependencies:
        - `read_all_zwiftpower_cp_graph_files_in_folder`: Reads ZwiftPower critical power data files.
    ...
    raw_cp_dict_for_betel = read_all_zwiftpower_cp_graph_files_in_folder(betel_IDs, INPUT_ZWIFTPOWER_CPDATA_FROM_DAVEK_DIRPATH)
