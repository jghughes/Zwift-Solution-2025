...
The dataset on which this tool operates is generated by tool08.py. Don't run this tool until you have run tool08.py first. 
...
from handy_utilities import read_dict_of_regressionmodellingDTO
...
def child_01(dict_of_regression_modellingItem : Dict[str, RegressionModellingItem], logger) -> None:
    ############################################################################################
        # # display all the items in the dict_of_regression_modellingItem - the 9 datapoints are the same as in the 
        # zwift feed power curve from 1 minute to 60 minutes. not doing linear regression here, just displaying the data
    ############################################################################################
    ...
    xdata_zsun_curve_fit = [item.zsun_one_hour_watts for item in dict_of_regression_modellingItem.values()]
    ydata_zwiftprofile_ftp = [item.zwift_ftp for item in dict_of_regression_modellingItem.values()]
...
def child_02(dict_of_regression_modellingItem : Dict[str, RegressionModellingItem], logger) -> None:
    ############################################################################################
...
def child_03(dict_of_regression_modellingItem : Dict[str, RegressionModellingItem], logger) -> None:
    ############################################################################################
...
def child_04(dict_of_regression_modellingItem : Dict[str, RegressionModellingItem], logger) -> None:
############################################################################################
    # # do modelling with linear regression - this time excluding the 20 minute datapoint (bp_1200)
    ## because this is the datapoint that is the model above gives a negative weighting to
...
def child_05(dict_of_regression_modellingItem : Dict[str, RegressionModellingItem], logger) -> None:
    ############################################################################################
        # do modelling with linear regression - this time excluding the 20 minute datapoint (bp_1200)
        # because this is the datapoint that is the model above gives a negative weighting to
...
def child_06(dict_of_regression_modellingItem : Dict[str, RegressionModellingItem], logger) -> None:
    ###########################################################################################
...
def child_07(dict_of_regression_modellingItem : Dict[str, RegressionModellingItem], logger) -> None:
    ###########################################################################################
...
def child_08(dict_of_regression_modellingItem : Dict[str, RegressionModellingItem], logger) -> None:
    ###########################################################################################
...
def main():
    ...
    FILENAME_OF_DATASET_FOR_REGRESSION_ANALYSIS = "bestpower_dataset_for_linear_regression_investigations_using_sklearn.json"
    INPUT_DIRPATH = "C:/Users/johng/holding_pen/StuffForZsun/!StuffFromDaveK_byJgh/zsun_everything_2025-04-00/"

    dict_of_candidate_regression_modellingItem = read_dict_of_regressionmodellingDTO(FILENAME_OF_DATASET_FOR_REGRESSION_ANALYSIS, INPUT_DIRPATH)
    ...
    # child_01(dict_of_regression_modellingItem, logger)
    # child_02(dict_of_regression_modellingItem, logger)
    # child_03(dict_of_regression_modellingItem, logger)
    # child_04(dict_of_regression_modellingItem, logger)
    # child_05(dict_of_regression_modellingItem, logger)
    # child_06(dict_of_regression_modellingItem, logger)
    # child_07(dict_of_regression_modellingItem, logger)
    child_08(dict_of_regression_modellingItem, logger)
