...
import unittest
import numpy as np
from critical_power_models import decay_model_numpy
...
class TestInverseModelNumpy(unittest.TestCase):
    def test_normal_array(self):
        ...
        np.testing.assert_almost_equal(decay_model_numpy(x, a, b), expected, decimal=7)
    ...
    def test_empty_array(self):
        ...
        np.testing.assert_array_equal(decay_model_numpy(x, a, b), expected)
