...
from jgh_formulae08 import search_for_paceline_solutions_using_parallel_workstealing,  compute_a_single_paceline_solution_complying_with_exertion_constraints
...
def main():
    ...
    (pull_plans, total_num_of_all_conceivable_plans, total_compute_iterations, compute_time) = search_for_paceline_solutions_using_parallel_workstealing(riders, STANDARD_PULL_PERIODS_SEC, lowest_bound_speed, MAX_INTENSITY_FACTOR)
    ...
    while len(current_riders) > 2:
        ...
        (pull_plans, num_alternatives, num_iterations, compute_time) = search_for_paceline_solutions_using_parallel_workstealing(
