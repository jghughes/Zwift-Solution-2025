...
from zwiftpower_90day_best_item import ZwiftPowerCurveOf90DayBestPowerItem
...
def translate_efforts_into_criticalpower_item(rider: ZsunRiderItem, rider_exertions: Dict[ZsunRiderItem, List[RiderExertionItem]], cp_test_duration_specs: List[int]) -> ZwiftPowerCurveOf90DayBestPowerItem:
    """
...
def main() -> None:
    ...
    for i, pull_speed_scenario in enumerate(pull_speeds_kph):
        ...
        dict_of_riders_and_their_criticalpower_curve: Dict[ZsunRiderItem, ZwiftPowerCurveOf90DayBestPowerItem] = {}
