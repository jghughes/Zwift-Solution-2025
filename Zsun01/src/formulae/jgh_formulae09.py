...
def generate_fastest_paceline_plan_for_n_strongest(ingredients: PacelineIngredientsItem, n: int, logger: logging.Logger) -> PacelineComputationReportDisplayObject:
