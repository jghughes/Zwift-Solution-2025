...
from paceline_plan_captions import (
    ...
    DICT_OF_CAPTION_PARTS_FOREACH_PACELINE_PLAN,
...
def populate_title_for_pace_plan(plan_type_enum: PacelinePlanTypeEnum,
    ...
    plan_report_displayobject.display_caption_left_aligned = f"{caption_part_a}         {format_number_1dp(plan_report_displayobject.calculated_average_speed_of_paceline_kph)}kph     {caption_part_b}"
