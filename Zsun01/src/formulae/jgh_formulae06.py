...
def add_zwift_cp_and_w_prime_to_rider_answer_items(rider_answer_items: Dict[ZsunRiderItem, RiderAnswerItem], zwiftriders_zwift_cp_data: Dict[str, ZwiftPowerCurveOf90DayBestPowerItem]
    ...
    Args:
        ...
        zwiftriders_zwift_cp_data (Dict[str, ZwiftPowerCurveOf90DayBestPowerItem]): The critical power items. Key is str(zwiftid).
    Returns:
