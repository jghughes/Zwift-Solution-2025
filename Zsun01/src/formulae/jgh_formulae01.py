...
def calculate_rider_kph_from_watts(wattage: float, rider_weight: float, rider_height: float, slope_pc: float = DEFAULT_PACELINE_SLOPE_PC, aero_factor: float = AERO_POSITION_FACTOR_DEFAULT) -> float:
    """
