...
- estimate_speed_from_wattage(wattage, weight, height, slope):
...
Example Usage:
--------------
    speed = estimate_speed_from_wattage(300, 75, 183, 0.0)
...
from jgh_formulae00 import calculate_frontal_area, solve_velocity_from_power, solve_power_from_velocity
...
def estimate_speed_from_wattage(wattage: float, weight: float, height: float, slope: float) -> float:
    """
