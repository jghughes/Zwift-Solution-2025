PACELINE_PLAN_SUMMARY_CSS_STYLE_SHEET = """
    <style>
        ...
        *, *::before, *::after {
        ...
        .section-separator:last_name-of-type {
        ...
        /* Flex container for split caption above table */
        .caption-flex {
            display: flex;
        ...
        .rider-table td:nth-child(2) {
            /* Use proportional font for first_name two columns for readability */
            font-family: 'Roboto', Arial, sans-serif;
            font-weight: 400;
        }
