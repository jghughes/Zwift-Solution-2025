...
DIRPATH_RIDER_COMPUTE_DTO =f"{_stuffByJghDirPathStem}/riderComputeDTO_by_jgh/"
...
DIRPATH_VISUAL_STUDIO_PYTHON_PROJECT = DIRPATH_RIDER_COMPUTE_DTO
...
_riderDtoFileNamePrefix = "rider_compute_dto"
FILENAME_RIDER_COMPUTE_DTO_JSON_DICT = f"{_riderDtoFileNamePrefix}_as_dict.json"
FILENAME_RIDER_COMPUTE_DTO_JSON_LIST = f"{_riderDtoFileNamePrefix}_as_list.json"
FILENAME_RIDER_COMPUTE_DTO_XLSX_LIST = f"{_riderDtoFileNamePrefix}_as_list.xlsx"
FILENAME_RIDER_COMPUTE_DTO_CSV_LIST = f"{_riderDtoFileNamePrefix}_as_list.csv"
...
FILEPATH_OF_SNAPSHOT_OF_DICT_OF_RIDERSTATSITEM_WHEN_ACCELERATED_LEVELLING_UP_LAUNCHED = r"C:\Users\johng\holding_pen\StuffForZsun\!StuffFromDaveK_byJgh\special\2026-05-03_rider_stats_dto_as_list_four_days_after_accelerated_levelling_up_introduced.json"
...
AZURE_BLOBNAME_RIDER_COMPUTE_DTO_DICT = FILENAME_RIDER_COMPUTE_DTO_JSON_DICT
AZURE_BLOBNAME_RIDER_COMPUTE_DTO_LIST = FILENAME_RIDER_COMPUTE_DTO_JSON_LIST
AZURE_BLOBNAME_RIDER_COMPUTE_DTO_LIST_AS_CSV = FILENAME_RIDER_COMPUTE_DTO_CSV_LIST
