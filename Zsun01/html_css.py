FOOTNOTES = """
<div class="footnote">
    <div class="footnote-item"><sup>1</sup> Pull is the Watts and duration for each rider's pull at the front. Higher ranking riders are prioritised for longer pulls and are located top and bottom of the paceline list, protecting weaker riders in the middle. Standard pulls range between 30 seconds and five minutes and corresponding pull capabilities are taken from a curve fitted to a rider's ZwiftPower data in their 3.5 - 20 minute window. Riders are not ranked according to zFTP, they are ranked according to how hard they can pull for one-minute.</div>
    <div class="footnote-item"><sup>2</sup> zFTP is the acronym for Zwift Functional Threshold Power. zFTP metrics are displayed, but play no role in computations.</div>
    <div class="footnote-item"><sup>3</sup> NP is the acronym for Normalized Power. Calculated from rolling-average watts using a five-second window.</div>
    <div class="footnote-item"><sup>4</sup> IF is the acronym for Intensity factor. Intensity of effort measured in terms of normalised power divided by one-hour pulling capability. One-hour capability is taken from a curve fitted to a rider's ZwiftPower data in the 8 - 40-minute window and extrapolated to one hour. Sigma is the standard deviation of all IFs for the team. Smaller is superior.</div>
    <div class="footnote-item"><sup>5</sup> Limit indicates which metric for which rider constrains the max speed of the paceline. The restriction protects riders who are assigned to pull from being pushed beyond their limits. They should be able to play their part without undue stress. In practice, the upshot is that the speed of the paceline is constrained by the pulling capability of the weakest puller and/or the intensity factor of the hardest-working puller. No such protection is afforded to non-pulling riders. They might or might not get dropped.</div>
</div>
"""
