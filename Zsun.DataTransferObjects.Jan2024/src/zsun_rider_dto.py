...
class ZsunRiderDTO(BaseModel):
    ...
    zsun_ftp_curve_coefficient  : Optional[float] = 0.0   # Coefficient for FTP modeling
    zsun_ftp_curve_exponent     : Optional[float] = 0.0   # Exponent for FTP modeling
    zsun_ftp_curve_fit_r_squared : Optional[float] = 0.0   # R-squared value for the curve fit of the FTP data
    zsun_pull_curve_coefficient : Optional[float] = 0.0   # Coefficient for pull modeling
    zsun_pull_curve_exponent    : Optional[float] = 0.0   # Exponent for pull modeling
    zsun_cp                     : Optional[float] = 0.0   # Critical power in watts
    zsun_w_prime                : Optional[float] = 0.0   # Critical power W' in kilojoules
