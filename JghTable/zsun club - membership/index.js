...
const BASE_COLUMN_DEFS = [
    ...
    { headerName: "lead_in (km)", field: "route_lead_in_length_km", type: 'numericColumn', width: 80, valueFormatter: params => params.value?.toFixed(1) },
    { headerName: "length (km)", field: "route_length_km", type: 'numericColumn', width: 80, valueFormatter: params => params.value?.toFixed(1) },
    { headerName: "power (W)", field: "route_power_output_watts", type: 'numericColumn', width: 80, valueFormatter: params => params.value?.toFixed(0) },
    { headerName: "power (W/kg)", field: "route_power_output_wkg", type: 'numericColumn', width: 80, valueFormatter: params => params.value?.toFixed(2) },
    { headerName: "time (sec)", field: "route_fastest_achievable_time_sec", type: 'numericColumn', width: 80, valueFormatter: params => params.value?.toFixed(0) },
    { headerName: "time (HhMmSs)", field: "route_fastest_achievable_time_hh_mm_ss", width: 80 },
