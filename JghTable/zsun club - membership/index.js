...
const BASE_COLUMN_DEFS = [
    ...
    { headerName: "zFTP w/kg", field: "zwift_zftp_wkg", type: 'numericColumn', valueFormatter: params => params.value?.toFixed(1), width: 80 },
    { headerName: "60min w/kg", field: "wkg_60min_curvefit", type: 'numericColumn', valueFormatter: params => params.value?.toFixed(1), width: 80 },
    { headerName: "prediction HhMmSs", field: "prediction_duration_hh_mm_ss", width: 80 },
    { headerName: "prediction distance km", field: "prediction_distance_km", type: 'numericColumn', width: 80 },
    { headerName: "prediction sec", field: "prediction_duration_sec", type: 'numericColumn', width: 80 },
