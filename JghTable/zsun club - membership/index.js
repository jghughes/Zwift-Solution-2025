...
const BASE_COLUMN_DEFS = [
    ...
    { headerName: "open cat", field: "cat_open", cellStyle: { textAlign: 'center' }, width: 80 },
    { headerName: "women cat", field: "cat_women", cellStyle: { textAlign: 'center' }, width: 80 },
    ...
    { headerName: "route", field: "route_name", type: 'numericColumn', width: 150 },
    { headerName: "details", field: "route_description", type: 'numericColumn', width: 150 },
    { headerName: "km (lead_in)", field: "route_lead_in_km", type: 'numericColumn', width: 90, valueFormatter: params => params.value?.toFixed(1) },
    { headerName: "km (length)", field: "route_length_km", type: 'numericColumn', width: 90, valueFormatter: params => params.value?.toFixed(1) },
    { headerName: "W", field: "route_watts", type: 'numericColumn', width: 90, valueFormatter: params => params.value?.toFixed(0) },
    { headerName: "W/kg", field: "route_wkg", type: 'numericColumn', width: 90, valueFormatter: params => params.value?.toFixed(2) },
    { headerName: "seconds", field: "route_sec", type: 'numericColumn', width: 90, valueFormatter: params => params.value?.toFixed(0) },
    { headerName: "HhMmSs", field: "route_hh_mm_ss", width: 90 },
    { headerName: "kph", field: "route_kph", type: 'numericColumn', width: 90, valueFormatter: params => params.value?.toFixed(1) },
