...
const BASE_COLUMN_DEFS = [
    ...
    { headerName: "km (60min 0% slope)", field: "jgh_60_min_km_0pc_slope", type: 'numericColumn', valueFormatter: params => params.value?.toFixed(1) },
    { headerName: "km (60min 2% slope)", field: "jgh_60_min_km_2pc_slope", type: 'numericColumn', valueFormatter: params => params.value?.toFixed(1) },
    { headerName: "km (60min 4% slope)", field: "jgh_60_min_km_4pc_slope", type: 'numericColumn', valueFormatter: params => params.value?.toFixed(1) },
