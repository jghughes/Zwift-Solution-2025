...
const BASE_COLUMN_DEFS = [
    ...
    { headerName: "FTP W (curve fit)", field: "jgh_60_min_watts", type: 'numericColumn', valueFormatter: params => params.value?.toFixed(0) },
    { headerName: "0% slope 60min km", field: "jgh_60_min_km_0pc_slope", type: 'numericColumn', valueFormatter: params => params.value?.toFixed(1) },
    { headerName: "2% slope 60min km", field: "jgh_60_min_km_2pc_slope", type: 'numericColumn', valueFormatter: params => params.value?.toFixed(1) },
    { headerName: "4% slope 60min km", field: "jgh_60_min_km_4pc_slope", type: 'numericColumn', valueFormatter: params => params.value?.toFixed(1) },
    { headerName: "8% slope 60min km", field: "jgh_60_min_km_8pc_slope", type: 'numericColumn', valueFormatter: params => params.value?.toFixed(1) },
