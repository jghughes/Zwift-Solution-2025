...
class LogFilenames:
    ...
    debug         | str | None   | The filename for debug level logs. Must end with .log. Default is None.
    info          | str | None   | The filename for info level logs. Must end with .log. Default is None.
    warning       | str | None   | The filename for warning level logs. Must end with .log. Default is None.
    error         | str | None   | The filename for error level logs. Must end with .log. Default is None.
    critical      | str | None   | The filename for critical level logs. Must end with .log. Default is None.
    """
